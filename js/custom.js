...
/*	$portfoliocontainer.find('img').adipoli({
	...
	/*******************************
	* Carlos Meza the Web Designer
	* *****************************
	*/

	var $cv = $("#cv");
	/*$cv.ready(function(){
		$("div.text-field div.text-field-right div.text").hide();
	});
	$cv.ready(function(){
		$("div.text-field").click(function(){
			$("div.text-field div.text-field-right div.text").toggle();
		});
	})*/

	(function($) {
		var cvallPanels = $('.accordion div.text-field-right div.text').hide();
		$cv.ready(function(){
			$(".accordion div.text-field").click(function() {
				$target = $(this).find('div.text');
				if(!$target.hasClass('active')){
					cvallPanels.removeClass('active').slideUp();
